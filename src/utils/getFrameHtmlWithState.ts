import { Frame, GetFrameHtmlOptions } from "frames.js";
 ...
 */
export function getFrameHtmlHead(frame: Frame & {state?: any}): string {
  const tags = [
    ...
    `<meta name="fc:frame:post_url" content="${frame.postUrl}"/>`,
		`<meta name="fc:frame:state" content="${frame.state}"/>`,
